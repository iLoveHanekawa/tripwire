...
CREATE TABLE "RoleHasPermission" (
    ...
    CONSTRAINT "RoleHasPermission_pkey" PRIMARY KEY ("roleId","permissionsId")
);
...
-- AddForeignKey
ALTER TABLE "RoleHasPermission" ADD CONSTRAINT "RoleHasPermission_permissionsId_fkey" FOREIGN KEY ("permissionsId") REFERENCES "Permission"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
